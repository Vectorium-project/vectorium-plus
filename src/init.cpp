...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/VectoriumPlusorg/VCTPwalletsource>";
    const std::string URL_WEBSITE = "<https://www.VectoriumPlus.org/>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("VectoriumPlus version %s\n", FormatFullVersion());
}
