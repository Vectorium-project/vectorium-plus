...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VectoriumPlus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VectoriumPlus: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VectoriumPlus addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VectoriumPlus addresses"));
    ...
    openAction->setStatusTip(tr("Open a VectoriumPlus: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible VectoriumPlus command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VectoriumPlus network", "", count));
}
...
{
    QString strTitle = tr("VectoriumPlus"); // default title
